"""
generate_step_v17.py - Generate STEP files directly using CadQuery

Creates the same geometry as the CATIA macro workflow but outputs STEP/STL directly.
Uses the same profile generation as generate_planetary_cad_v17.py.
"""
