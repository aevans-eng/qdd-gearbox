"""
generate_planetary_cad_v15.py - Ring rotation sweep
...
print("=" * 60)
print("PLANETARY GEAR EXPORT v15 (ring rotation sweep)")
print("=" * 60)
...
output_dir = "output_herringbone_v15"
...
print("\n" + "=" * 60)
print("v15 COMPLETE - Ring rotation sweep")
print("=" * 60)
