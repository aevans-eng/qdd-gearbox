"""
generate_step_v20.py - Print-in-Place Herringbone Planetary Gearbox (4 Planets)

Generates STEP/STL files with optimized clearance for print-in-place FDM.
Based on v19 but with 4 planet gears instead of 3 for increased torque capacity.
"""
...
print("=" * 60)
print("STEP FILE GENERATOR v20 (4 Planets, 0.20mm clearance)")
print("=" * 60)
...
print("  - Individual gears: sun.stl, planet_0/1/2/3.stl, ring.stl")
