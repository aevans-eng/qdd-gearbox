"""
generate_step_v18.py - Print-in-Place Herringbone Planetary Gearbox

Generates STEP/STL files with proper clearance for print-in-place FDM printing.
Based on v17 with increased tooth clearance (0.4mm total at mesh interfaces).
"""
...
# -0.20mm per gear = ~0.40mm total clearance at each mesh interface
PROFILE_OFFSET_MM = -0.20
RING_OFFSET_DEG = 0.2

# Output directory
OUTPUT_DIR = "step_output_v18"

print("=" * 60)
print("STEP FILE GENERATOR v18 (Print-in-Place)")
print("=" * 60)
