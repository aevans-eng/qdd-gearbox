Sub CATMain()
    ' =====================================================
    ' ImportGearbox_v16 for 3DEXPERIENCE (Two-Phase)
    '
    ...
    '   - Planets pre-positioned in XYZ files
    ' =====================================================
    ...
    basePath = "C:\Obsidian\MegaVault\Projects\Flagship\3DX\Actuator Development\HackathonActuator\output_herringbone_v16\"
    ...
    gearNames(0) = "sun_6"
    gearNames(1) = "planet_12_0"
    gearNames(2) = "planet_12_1"
    gearNames(3) = "planet_12_2"
    gearNames(4) = "ring_30"
    ...
    MsgBox "Phase 1 Complete!" & vbCrLf & vbCrLf & _
           ...
           "  - Sun (6 teeth)" & vbCrLf & _
           "  - Planet 0, 1, 2 (12 teeth each)" & vbCrLf & _
           "  - Ring (30 teeth)" & vbCrLf & vbCrLf & _
    ...
    MsgBox "v16 Gearbox Complete!" & vbCrLf & vbCrLf & _
           "Features:" & vbCrLf & _
           "  - Profile offset: -0.05mm" & vbCrLf & _
           "  - Ring compensation: 0.2deg" & vbCrLf & vbCrLf & _
