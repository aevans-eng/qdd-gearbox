"""
generate_step_v24.py - Low Friction Clearance Herringbone Planetary Gearbox

Based on v22 with same teeth (R48/P18/S12) but:
- Profile offset: -0.05mm per gear = 0.05mm total clearance
- Same 30° helix angle
...
PROFILE_OFFSET_MM = -0.025  # -0.05mm per gear = 0.05mm total clearance
RING_OFFSET_DEG = 0.2
...
# Output directory
OUTPUT_DIR = "step_output_v24"

print("=" * 60)
print("STEP FILE GENERATOR v24 (Low Friction Clearance, 30° Helix)")
print("=" * 60)
...
print(f"\n--- v24: Low Friction Clearance ---")
print(f"Fit: {PROFILE_OFFSET_MM:+.2f}mm (halfway between v23 and v22)")
print()
print(f"--- Geometry ---")
