"""
generate_planetary_cad_v16.py - With profile offset tolerance

Based on v15 (simple ring compensation) + profile offset for backlash.
...
print("=" * 60)
print("PLANETARY GEAR EXPORT v16 (with profile offset tolerance)")
print("=" * 60)
...
output_dir = "output_herringbone_v16"
