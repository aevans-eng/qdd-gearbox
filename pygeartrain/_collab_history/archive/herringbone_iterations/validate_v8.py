"""Validate v8 - full assembly view"""
import numpy as np
import matplotlib.pyplot as plt
import os

output_dir = "output_herringbone_v8"
...
plt.suptitle('v8 Full Validation - Mesh Axis Alignment (20° helix)', fontsize=14, fontweight='bold')
plt.tight_layout()
