"""
generate_step_v23.py - Low Friction Clearance Herringbone Planetary Gearbox

Based on v22 with same teeth (R48/P18/S12) but:
- Profile offset: -0.05mm per gear = 0.10mm total clearance
- Same 30° helix angle

Goal: Balanced clearance - less friction than 0.00mm, tighter than -0.10mm.
"""
...
PROFILE_OFFSET_MM = -0.05  # -0.05mm per gear = 0.10mm total clearance
RING_OFFSET_DEG = 0.2
...
# Output directory
OUTPUT_DIR = "step_output_v23"

print("=" * 60)
print("STEP FILE GENERATOR v23 (Low Friction Clearance, 30° Helix)")
print("=" * 60)
...
print(f"\n--- v23: Low Friction Clearance ---")
print(f"Fit: {PROFILE_OFFSET_MM:+.2f}mm (balanced between 0.00 and -0.10)")
print()
print(f"--- Geometry ---")
